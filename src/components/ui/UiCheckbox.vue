...
<template>
  <label class="inline-flex items-center gap-2 cursor-pointer select-none" :class="{ 'opacity-50 cursor-not-allowed': disabled }">
    <div class="relative flex items-center">
      ...
      />
      <div 
        class="w-5 h-5 rounded-md bg-neutral-100 shadow-inner transition-all peer-checked:bg-primary-500 peer-checked:shadow-clay-btn peer-focus:ring-2 peer-focus:ring-primary-500/20 peer-enabled:hover:bg-white peer-enabled:peer-checked:hover:bg-primary-600"
      ></div>
      <svg 
